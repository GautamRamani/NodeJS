...
router.post('/add', function(req, res, next) {    
    ...
    if(name.length === 0 || email.length === 0 || position === 0 || password===0) {
        errors = true;

        // set flash message
        req.flash('error', "Please enter name and email and position and password");
...
router.post('/update/:id', function(req, res, next) {
    ...
    if(name.length === 0 || email.length === 0 || position.length === 0 || password.length===0) {
        errors = true;
